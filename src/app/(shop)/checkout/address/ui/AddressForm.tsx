...
export const AddressForm: React.FC<AddressFormProps> = ({ countries, userStoredAddress = {} }) => {
    ...
    const onSubmit: SubmitHandler<FormInputs> = async ({ rememberAddress, ...data }) => {
        ...
        else await removeUserAddress(session?.user.id!)
        ...
        <form onSubmit={ handleSubmit(onSubmit) } className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
                ...
                <button
                    ...
                    type="submit"
                    className={clsx(
                        "flex w-full sm:w-1/2 justify-center cursor-pointer",
                        {
                            'btn-primary': isValid,
